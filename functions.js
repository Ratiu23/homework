console.info("We're inside functions");
...
console.info("Employees by first names: " + collectFristNames(employees));
...
console.info("Average salary: " + calculateAverageSalary(employees));
...
console.info("Average slary for females: " + calculateAverageFemaleSalary(employees));
...
function splitEmployees(employees) {
    ...
    employees.forEach( e => {
        ...
        //e.gender=="Female" ? f.push(e) : m.push(e); 
        (e.gender=="Female" ? f:m).push(e);


    });
    return {f,m};
}
console.info("Employees by gender: ");
